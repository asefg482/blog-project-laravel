...
@section('page_content')
    ...
    <article class="entry entry-single">
        ...
        <div class="entry-img">
            <img src="{{route('file-manager.show',$blog['image'])}}" alt="{{$blog['description']}}" class="img-fluid">
        </div>
    ...
    <div class="blog-author d-flex align-items-center">
        <img src="{{asset('assets/admin/images/faces-clipart/pic-1.png')}}" class="rounded-circle float-left" alt="">
        <div>
